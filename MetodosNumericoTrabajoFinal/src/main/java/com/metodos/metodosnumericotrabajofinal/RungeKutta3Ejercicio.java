...
public class RungeKutta3Ejercicio {
...
//        new SwingWrapper<>(chart).displayChart();
    ...
    public static void main(String[] args) {
          ...
          Function<DifferentialEquation, Double> funcion = equation -> (0.026)*(1-equation.y/12000) * equation.y;
        ...
        double x0 = 1950; // Valor inicial de x
        double y0 = 2555; // Valor inicial de y

        // Definimos el tamaño del paso
        double h = 10; // Tamaño del paso

        // Definimos el valor de x para el cual queremos obtener el valor de y
        double x = 2000; // Valor de x para el cual queremos obtener y

        // Aplicamos el método de Runge-Kutta de cuarto orden
        RungeKutta3Ejercicio rs = new RungeKutta3Ejercicio();
